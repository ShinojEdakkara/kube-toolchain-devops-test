...
usage()
{
   ...
   echo "                                             key:value pairs. Example: analyticsconsole/mfp.analytics.url:analytics-service"
   echo
...
then
    export ARGS_PROPS_FILE="startanalytics.properties"
    recordInputParams ANALYTICS_IMAGE_TAG=$ANALYTICS_IMAGE_TAG ANALYTICS_CONTAINER_NAME=$ANALYTICS_CONTAINER_NAME ANALYTICS_IP=$ANALYTICS_IP SSH_ENABLE=$SSH_ENABLE ENABLE_VOLUME=$ENABLE_VOLUME ENABLE_ANALYTICS_DATA_VOLUME=$ENABLE_ANALYTICS_DATA_VOLUME ANALYTICS_DATA_VOLUME_NAME=$ANALYTICS_DATA_VOLUME_NAME ANALYTICS_DATA_DIRECTORY=$ANALYTICS_DATA_DIRECTORY EXPOSE_HTTP=$EXPOSE_HTTP EXPOSE_HTTPS=$EXPOSE_HTTPS SERVER_MEM=$SERVER_MEM SSH_KEY=$SSH_KEY TRACE_SPEC=$TRACE_SPEC MAX_LOG_FILES=$MAX_LOG_FILES MAX_LOG_FILE_SIZE=$MAX_LOG_FILE_SIZE MFPF_PROPERTIES=$MFPF_PROPERTIES
fi
...
ANALYTICS_CLUSTER_NAME=mfpf_analytics_cluster_$ANALYTICS_CONTAINER_NAME
